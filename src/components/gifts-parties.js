      ...
      <div>
        ...
        <div className="container desktop-views">
          <div className="intro-section">
            ...
            <p>
              We make it easy to share our passion filled macarons with your
              friends, family and colleagues. Choose from our array of premium
              gift options, or we can create a customized arrangement just for
              you. Contact us when you need help planning your celebration at{' '}
              <a
                href="mailto:orders@mboutique.com?Subject=Service%20Inquiry"
                target="_top"
              >
          ...
          <div className="giftbox-section">
            <h5>Gift Boxes</h5>
            <p>
              Our signature gift boxes make macarons the perfect gift for any
              occassion! Gift boxes come in raspberry, white, pistachio, violet,
              silver, and gold.
            </p>
            <ul>
          ...
          <div className="tower-section">
            <h5>Party Tower</h5>
            <p>
              Our 5-tiered party tower becomes the centerpiece of any special
              event or private celebration, elegantly presenting your unique
              selection of sixty macarons!
            </p>
            <ul>
